...
%>
	...
	<header>
		<div class="header-area">
							...
							<nav>
								<ul id="navigation">
									...
									<li><a href="blog.html">Category</a>
										<ul class="submenu">
											<li><a href="upload-product.jsp">Electronics</a></li>
											<li><a href="manage-product.jsp">Clothes</a></li>
											<li><a href="manage-product.jsp">Footware</a></li>
											<li><a href="manage-product.jsp">Furniture</a></li>
										</ul></li>
							...
							<ul>
								<li>
									<div class="nav-search search-switch hearer_icon">
										<a id="search_1" href="javascript:void(0)"> <span
											class="flaticon-search"></span>
										</a>
									</div>
								</li>
								<%List<WishList> wlist = WishLIstDAO.getWishListByCusId(s.getId());  %>
								<li><a href="wishlist.jsp"><span class="ti-heart"><%out.print(wlist.size()); %></span></a></li>
			...
			<div class="header-bottom text-center">
				<p>
					Sale Up To 50% Biggest Discounts. Hurry! Limited Perriod Offer <a
						href="#" class="browse-btn">Shop Now</a>
				</p>
			</div>
		</div>
	</header>
	...
	<script defer
		...
		data-cf-beacon='{"rayId":"875253a08c4f4116","b":1,"version":"2024.3.0","token":"cd0b4b3a733644fc843ef0b185f98241"}'

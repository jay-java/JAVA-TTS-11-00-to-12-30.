										...
										<div class="properties-card">
											<div class="properties-img">
												<a href="pro-details.html"><img
													src="images/<%=p.getPimage() %>" alt></a>
												<div class="socal_icon">
													<a href="#"><i class="ti-shopping-cart"></i></a> <a
														href="WishListController?action=addtowishlist&cusid=<%=s.getId()%>&pid=<%=p.getPid()%>"><i class="ti-heart"></i></a> <a href="#"><i
